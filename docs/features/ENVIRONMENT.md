...
| Tests | `pnpm test` | **2 fallos de 1622** (`SearchSelect` ×2, preexistentes) |
| Paquete | `pnpm build` | chunk inicial **1.097,09 kB** (pasó del megabyte tras FEAT-005; el troceado es deuda propia) + `app-icons` 620 kB perezoso + `IconPicker` 4,6 kB |
