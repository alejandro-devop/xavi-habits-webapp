...
## Corpus Check
- 806 files · ~1,118,250 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4646 nodes · 5591 edges · 561 communities (436 shown, 125 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 940 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1337456c`
...
Cohesion: 0.06
Nodes (30): 1. La petición — feature-analyst, 2. El plan — feature-architect, 3. Construcción — feature-builder, 4. Revisión — feature-reviewer, ¿Arquitecto? **Sí**, Cierre de la feature — nota para el usuario, Criterios de aceptación, Cómo se modela la «sugerencia con respuesta guardada», una sola vez (+22 more)

### Community 7 - "Quarters Activatequarter"
Cohesion: 0.21
Nodes (11): useVidaWeekPlans(), VidaDayPlanDot, VidaWeekPlans, defaultLogStartTime(), formatReviewWeekRange(), formatWeekStoryLabel(), LogSheetState, mondayOf() (+3 more)
...
Cohesion: 0.06
Nodes (33): (0) Lo que YA está construido y en pantalla, 1. La petición — feature-analyst, (1) Lo que falta y SÍ se puede hacer hoy, sin tocar el API, 2. El plan — feature-architect, (2) Lo que NO se puede hoy, y manda sobre el alcance: la hora, 3. Construcción — feature-builder, (3) El cambio que necesita el API, campo a campo, 4. Revisión — feature-reviewer (+25 more)
...
Cohesion: 0.07
Nodes (30): Accumulator, answerNoteFor(), appliesTo(), BlockHintCandidate, bridgeAnswerNoteFor(), BuildActivityPatternsInput, formatPatternDate(), hintAsk() (+22 more)
...
Cohesion: 0.18
Nodes (10): formatNightTime(), nextDayLabel(), CROSSING, INSIDE, VidaNightBand(), VidaNightBandProps, VidaNightBandVariant, NIGHT (+2 more)
...
Cohesion: 0.07
Nodes (20): Trigger(), ConfirmDialogContext, ConfirmDialogContextValue, ConfirmDialogProviderProps, initialState, useConfirmDialog(), HabitDayRow(), HabitDayRowProps (+12 more)
...
Cohesion: 0.13
Nodes (21): useVidaDayHours(), VidaDayHours, resolveVidaDayWindow(), useVidaDayWindow(), useVidaWeekdayWindow(), VidaDayWindow, VidaDayWindowSource, useVidaNight() (+13 more)
...
Cohesion: 0.10
Nodes (21): afterClause(), beforeClause(), BuildGapRealWindowInput, describeGapWindowShift(), describePlacementBlocker(), GapNeighbour, RealGapWindow, plannedStartShortcut() (+13 more)
...
Cohesion: 0.21
Nodes (10): useActivityFollowUpsInDatesQuery(), useCreateActivityFollowUpMutation(), useDeleteActivityFollowUpMutation(), useStartActivityFollowUpMutation(), useUpdateActivityFollowUpMutation(), VidaMutationOptions, useSetVidaGoalDaysMutation(), useVidaSessionActions() (+2 more)
...
Cohesion: 0.09
Nodes (24): buildDayAgenda(), agendaAt(), collectDayClosing(), matchSessionsToBlocks(), toSessionSpans(), buildActivityPatterns(), build(), reviewOf() (+16 more)
...
Cohesion: 0.15
Nodes (16): VidaReviewBridgeSection(), getBlockNote(), getNightLog(), getStartTimeAnswerFor(), isBridgeDismissed(), isNoDataDismissed(), useVidaDeviceNotesStore, VidaBlockNote (+8 more)
...
Cohesion: 0.11
Nodes (20): useActivityDayPlanQuery(), useActivityDayFollowUpsQuery(), useSaveVidaItemForActivity(), useVidaDayData(), VidaDayData, useVidaHistoryWindow(), useCreateVidaItemMutation(), useDeleteVidaItemMutation() (+12 more)
...
Cohesion: 0.13
Nodes (17): AgendaBlock, AgendaEntry, AgendaGap, AgendaNowMark, BuildDayAgendaInput, buildGuidanceLine(), DayAgenda, DayBudget (+9 more)
...
Cohesion: 0.27
Nodes (8): describeBlock(), describeItemDays(), describeItemDuration(), describeItemMeta(), planCopyDay(), templateItemTitle(), VidaTemplateItemCard(), VidaTemplateItemCardProps
...
Cohesion: 0.22
Nodes (15): parseYmdToLocalDate(), buildDayStrip(), clampToPlanningWindow(), clampToReviewWindow(), clampToWindow(), DayStripDay, describePlanningWindowEdge(), describeReviewWindowEdge() (+7 more)
...
Cohesion: 0.24
Nodes (10): HABIT_TYPE_OPTIONS, Props, NewCategoryButton(), NewCategoryButtonProps, NewMeasureButton(), NewMeasureButtonProps, NewPurposeButton(), NewPurposeButtonProps (+2 more)
...
Cohesion: 0.10
Nodes (19): useAddDayPlanItemMutation(), useEditDayPlanItemMutation(), useRemoveDayPlanItemMutation(), formatNowLabel(), useVidaNowMinute(), VidaNowMinute, defaultLogStartTime(), defaultStartNowTime() (+11 more)
...
Cohesion: 0.12
Nodes (13): DAY_LETTERS, getLast7Days(), HabitsWidget(), HabitWeekSelector(), HabitWeekSelectorProps, HabitWeekViewPage(), sortMyDayEntries(), formatLocalDateToYmd() (+5 more)
...
Cohesion: 0.12
Nodes (13): buildWeekTotals(), describeTemplateDayTotals(), formatDurationFromMinutes(), buildUpNextEmpty(), VidaDayBudget(), VidaDayBudgetProps, VidaTemplateDaySummary(), VidaTemplateDaySummaryProps (+5 more)
...
Cohesion: 0.10
Nodes (14): AuthLayout(), HIGHLIGHTS, DataCard(), DataCardProps, DataCardVariant, Trend, TREND_CLASS, useReducedMotionPreference() (+6 more)
...
Cohesion: 0.53
Nodes (5): isValidHHmm(), nowHHmm(), pad2(), timeOfDayForDate(), toHHmm()
...
Cohesion: 0.19
Nodes (7): UseVidaHistoryWindowInput, VidaHistoryDay, VidaHistoryWindow, UseVidaPatternsInput, VidaAnsweredSuggestion, VidaPatternsResult, VidaPatternView
...
Cohesion: 0.13
Nodes (33): getVidaDayOfWeek(), crossesMidnight(), describeDiffToPlanned(), describeLoggedNightKind(), describeNightBandLog(), describeNightDays(), describeNightKind(), describeNightSpan() (+25 more)

### Community 396 - "Community 396"
Cohesion: 0.40
Nodes (3): addHabitFollowUp, habit, updateHabitFollowUp
...
Cohesion: 0.07
Nodes (26): 1. The request — feature-analyst, 2. The plan — feature-architect, 3. Construction — feature-builder, 4. Review — feature-reviewer, D1 — qué abre «Ver las otras N»: **(c), y se puede construir**, Dónde NO va (medido, para que nadie lo reconsidere), Dónde va el código nuevo, archivo a archivo, Dónde vive la regla: `utils/vida-up-next.utils.ts` (nuevo) (+18 more)
...
Cohesion: 0.29
Nodes (4): buildTemplateDay(), templateItemsForDay(), build(), grid()
...
Cohesion: 0.50
Nodes (5): countTemplateByDay(), describeFitAt(), durationOf(), hasTime(), whatIsAt()
...
- **Why does `VidaHoyPage()` connect `Community 206` to `Quarters Activatequarter`, `Community 395`, `Community 144`, `Community 419`, `Community 44`, `Community 302`, `Community 186`, `Popover Useclickoutside`, `Usehabitcategories Habitcategoriespage`, `Community 190`, `Community 200`, `Datacard Trend`, `Projectformmodal Usequarters`, `Searchselect Dropdownpos`, `Skeleton Skeletonprops`, `Community 101`, `Community 486`, `Community 230`, `Community 244`?**
...
- **Why does `useConfirmDialog()` connect `Modal Usereducedmotionpreference` to `Community 545`, `Community 230`, `Community 391`, `Community 200`, `Community 233`, `Community 49`, `Community 274`, `Community 54`, `Quarterformmodal Usequarters`, `Community 538`, `Community 508`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
...
- **Are the 46 inferred relationships involving `useToast()` (e.g. with `useCompleteActivityMutation()` and `useCreateActivityMutation()`) actually correct?**
  _`useToast()` has 46 INFERRED edges - model-reasoned connections that need verification._
