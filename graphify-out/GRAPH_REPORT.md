...
## Corpus Check
- 772 files · ~951,085 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4308 nodes · 5118 edges · 541 communities (420 shown, 121 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 874 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `384526a3`
...
9. `renderWithProviders()` - 21 edges
...
## Communities (541 total, 121 thin omitted)
...
Cohesion: 0.42
Nodes (8): capitalize(), formatDayForLabel(), formatLongDate(), formatWeekEyebrow(), formatWeekRange(), toDate(), withoutWeekdayComma(), getIsoWeekNumber()
...
Cohesion: 0.11
Nodes (18): buildNoDataSlices(), buildCategoryBreakdown(), buildWeekTotals(), describeTemplateDayTotals(), formatDurationFromMinutes(), formatTimeForDisplay(), buildUpNextEmpty(), VidaAgendaGap() (+10 more)
...
Cohesion: 0.09
Nodes (30): ElapsedFormat, Timer(), useVidaElapsed(), VidaElapsed, closeSessionInput(), correctStartInput(), describeOverPlan(), editSessionInput() (+22 more)
...
Cohesion: 0.11
Nodes (20): useVidaDayHours(), VidaDayHours, getDayBudget(), toDayPlanTimes(), appliesTo(), block(), day(), DAY_HOURS (+12 more)
...
Cohesion: 0.07
Nodes (40): pluralDayLabel(), Accumulator, answerNoteFor(), BlockHintCandidate, bridgeAnswerNoteFor(), BuildActivityPatternsInput, buildPattern(), buildSuggestion() (+32 more)
...
Cohesion: 0.17
Nodes (9): useActivitiesQuery(), useActivityQuery(), useCompleteActivityMutation(), useDeleteActivityMutation(), useUpdateActivityMutation(), useArchiveActivity(), VidaArchivadasPage(), DEFAULT_ACTIVITY_FILTERS (+1 more)
...
Cohesion: 0.08
Nodes (22): buildDayAgenda(), agendaAt(), matchSessionsToBlocks(), buildActivityPatterns(), build(), reviewOf(), BridgeCandidate, BridgeDayInput (+14 more)
...
Cohesion: 0.16
Nodes (15): VidaReviewBridgeSection(), getBlockNote(), getStartTimeAnswerFor(), isBridgeDismissed(), isNoDataDismissed(), useVidaDeviceNotesStore, VidaBlockNote, vidaBlockNoteKey() (+7 more)
...
Cohesion: 0.09
Nodes (18): HabitCard(), Props, HabitListCard(), HabitListCardProps, useCompleteHabitMutation(), countBy(), countHabitsByCategory(), countHabitsByPurpose() (+10 more)
...
Cohesion: 0.13
Nodes (19): useAddDayPlanItemMutation(), useEditDayPlanItemMutation(), useRemoveDayPlanItemMutation(), useCreateActivityFollowUpMutation(), useDeleteActivityFollowUpMutation(), useStartActivityFollowUpMutation(), useUpdateActivityFollowUpMutation(), VidaMutationOptions (+11 more)
...
Cohesion: 0.23
Nodes (9): useSetActivityDayPlanMutation(), BuildDayOutcome, BuildDayRequest, useBuildDayFromTemplate(), getVidaDayOfWeek(), sameWeekdayLastWeek(), PlanShortcuts(), VidaDayActions() (+1 more)
...
Cohesion: 0.04
Nodes (55): buildTemplateDay(), BuildTemplateDayInput, buildTemplateGuidance(), buildTemplateWeekGrid(), BuildTemplateWeekGridInput, busiestStretch(), capitalize(), countTemplateByDay() (+47 more)
...
Cohesion: 0.10
Nodes (13): renderAt(), renderConLapiz(), renderWithNoteSheet(), renderPage(), ProvidersProps, renderWithProviders(), BLOCK, renderBlock() (+5 more)
...
Cohesion: 0.23
Nodes (16): parseYmdToLocalDate(), resolveReviewDate(), buildDayStrip(), clampToPlanningWindow(), clampToReviewWindow(), clampToWindow(), DayStripDay, describePlanningWindowEdge() (+8 more)
...
Cohesion: 0.09
Nodes (21): HabitWeekSelector(), HabitWeekSelectorProps, useHabitFollowUpsInDatesQuery(), HabitCalendarPage(), HabitHistoryTab(), EMPTY_FOLLOW_UP_MAP, HabitMyDayPage(), RegisterTarget (+13 more)
...
Cohesion: 0.23
Nodes (10): useVidaWeekPlans(), VidaDayPlanDot, VidaWeekPlans, defaultLogStartTime(), formatReviewWeekRange(), formatWeekStoryLabel(), LogSheetState, mondayOf() (+2 more)
...
Cohesion: 0.25
Nodes (7): useVidaItemsQuery(), useVidaPatterns(), UseVidaPatternsInput, VidaAnsweredSuggestion, VidaPatternsResult, VidaPatternView, VidaPlantillaPage()
...
Cohesion: 0.17
Nodes (11): 1. The request — feature-analyst, 3. Construction — feature-builder, 4. Revisión — feature-reviewer, FEAT-013 — Empezar algo que ya empezó, Tajada 1 — «Empezar algo» pregunta a qué hora empezaste, Tajada 1 — «Empezar algo» pregunta a qué hora empezó, Tajada 2 — «Empecé antes»: corregir la hora de una sesión en marcha, Tajada 2 — «Empecé antes»: corregir la hora de una sesión en marcha (+3 more)

### Community 432 - "Community 432"
Cohesion: 0.16
Nodes (19): HabitCreateWizard(), HabitEditForm(), HabitFormModal(), HabitFormModalProps, useCreateHabitMutation(), useDeleteHabitMutation(), useHabitCategoriesQuery(), useHabitMeasuresQuery() (+11 more)
...
Cohesion: 0.18
Nodes (8): formatDurationMinutes(), buildUpNext(), VidaAgendaBlock(), VidaAgendaBlockProps, VidaStartTimeSheet(), VidaStartTimeSheetProps, VidaTemplateGapRow(), VidaTemplateGapRowProps
...
Cohesion: 0.20
Nodes (6): HabitFollowUpDrawer(), HabitFollowUpDrawerProps, useMediaQuery(), EMPTY_FOLLOW_UP_MAP, HabitsListPage(), hasActiveHabitFilters()
...
## Knowledge Gaps
- **1996 isolated node(s):** `name`, `private`, `version`, `type`, `packageManager` (+1991 more)
...
- **Why does `useConfirmDialog()` connect `Community 49` to `Skeleton Skeletonprops`, `Community 391`, `Community 231`, `Community 491`, `Usetodos Todossettings`, `Community 432`, `Community 274`, `Community 54`, `Quarterformmodal Usequarters`, `Community 25`, `Community 508`, `Community 509`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Community 93` to `Skeleton Skeletonprops`, `Community 227`, `Community 358`, `Community 391`, `Community 508`, `Community 432`, `Community 434`, `Community 243`, `Community 274`, `Toast Context`, `Quarterformmodal Usequarters`, `Community 89`, `Usehabitcategories Habitcategoriespage`, `Community 25`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `VidaHoyPage()` connect `Community 168` to `Skeleton Skeletonprops`, `Community 32`, `Community 65`, `Community 35`, `Community 101`, `Community 358`, `Community 230`, `Community 231`, `Community 299`, `Community 109`, `Community 302`, `Community 335`, `Projectformmodal Usequarters`, `Community 144`, `Community 370`, `Community 93`, `Community 190`, `Searchselect Dropdownpos`?**
