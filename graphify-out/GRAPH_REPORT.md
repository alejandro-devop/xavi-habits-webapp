...
## Corpus Check
- 621 files · ~386,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3117 nodes · 3512 edges · 459 communities (362 shown, 97 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 570 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f501bc2`
...
4. `useConfirmDialog()` - 20 edges
5. `compilerOptions` - 20 edges
6. `Habits Module — Implementation Plan` - 19 edges
7. `Fase 4 — Frontend: Feature folder base` - 19 edges
8. `formatTimeForDisplay()` - 17 edges
9. `restRequest()` - 16 edges
...
- `renderSheet()` --calls--> `renderWithProviders()`  [INFERRED]
  src/features/vida/components/VidaActivitySheet/VidaActivitySheet.test.tsx → src/test/render.tsx

## Import Cycles
- None detected.

## Communities (459 total, 97 thin omitted)
...
Cohesion: 0.11
Nodes (17): 1. The request — feature-analyst, 2. The plan — feature-architect, 3. Construction — feature-builder, 4. Review — feature-reviewer, Cómo se verifica cada tajada, Dónde NO va, Dónde va el código nuevo, archivo por archivo, FEAT-004 — Hoy — vivir el día: lo real encima de lo planeado, con cronómetro y registro (+9 more)
...
Cohesion: 0.12
Nodes (15): useVidaSessionUi(), VidaSessionUiContext, VidaSessionUiValue, useVidaWeekPlans(), VidaDayPlanDot, VidaWeekPlans, NO_SUGGESTIONS, SheetActivity (+7 more)
...
Cohesion: 0.18
Nodes (15): buildGuidanceLine(), findFirstFittingGap(), formatGapRange(), buildStartTimeOptions(), describeWindow(), windowMinutes(), formatDurationFromMinutes(), formatTimeForDisplay() (+7 more)
...
Cohesion: 0.24
Nodes (12): useVidaDayHours(), VidaDayHours, toDayPlanTimes(), minutesUntilEndTime(), calculateEndTime(), DURATION_PILLS, isEndAfterStart(), isValidHhMm() (+4 more)
...
Cohesion: 0.07
Nodes (35): DAY_LABELS, getCellClass(), HabitContributionGrid(), Props, DAY_LABELS, HabitDayCell(), Props, getMicrocopy() (+27 more)
...
Cohesion: 0.19
Nodes (12): describeLeftovers(), durationPillsForWindow(), fitsInWindow(), GapWindow, getMaxDurationForStartTime(), getPlacementLeftovers(), isStartTimeInsideWindow(), PlacementLeftovers (+4 more)
...
Cohesion: 0.29
Nodes (3): excludeArchivedActivities(), GroupAccumulator, VidaCatalogGroupModel
...
Cohesion: 0.26
Nodes (11): invalidateFollowUpQueries(), formatDateToYmd(), getCurrentLocalDate(), getCurrentWeekRange(), getMondayOfWeek(), isFutureDate(), isToday(), pad2() (+3 more)
...
Cohesion: 0.27
Nodes (9): closeSessionInput(), elapsedMinutes(), followUpStartInstant(), formatElapsedHHMMSS(), pad2(), sessionStartInstant(), startSessionInput(), UnknownEndReason (+1 more)

### Community 141 - "Community 141"
Cohesion: 0.27
Nodes (5): formatDaysLabel(), VidaActivityCard(), VidaActivityCardProps, VidaDurationPills(), VidaDurationPillsProps
...
Cohesion: 0.25
Nodes (6): useActivityDayPlanQuery(), useVidaDayData(), VidaDayData, useVidaSuggestionsForDateQuery(), useVidaSessionPlannedMinutes(), VidaOpenSession
...
Cohesion: 0.19
Nodes (12): useActivityDayFollowUpsQuery(), useActivityFollowUpsInDatesQuery(), useActivityOpenFollowUpQuery(), useCreateActivityFollowUpMutation(), useDeleteActivityFollowUpMutation(), useStartActivityFollowUpMutation(), useUpdateActivityFollowUpMutation(), VidaMutationOptions (+4 more)
...
Cohesion: 0.32
Nodes (4): ChosenActivity, preselectedDuration(), VidaPlaceInGapSheet(), VidaPlaceInGapSheetProps
...
Cohesion: 0.16
Nodes (13): useActivitiesQuery(), useActivityCategoriesQuery(), useActivityCategoryQuery(), useDeleteActivityCategoryMutation(), useUpdateActivityCategoryMutation(), useVidaItemsQuery(), useVidaTakenTodayQuery(), useVidaQueryGuard() (+5 more)
...
Cohesion: 0.24
Nodes (13): formatWeekRange(), mondayOf(), shiftYmd(), VidaSemanaPage(), parseYmdToLocalDate(), buildDayStrip(), clampToPlanningWindow(), DayStripDay (+5 more)
...
Cohesion: 0.43
Nodes (5): pluralDayLabel(), tomorrowOf(), VidaTemplateAside(), VidaTemplateAsideProps, VidaTomorrowBlock()
...
Cohesion: 0.20
Nodes (8): useSetActivityDayPlanMutation(), BuildDayOutcome, BuildDayRequest, useBuildDayFromTemplate(), sameWeekdayLastWeek(), shiftYmd(), VidaDayActions(), VidaDayActionsProps
...
Cohesion: 0.16
Nodes (17): Trigger(), useConfirmDialog(), HabitCreateWizard(), HabitEditForm(), HabitFormModal(), HabitFormModalProps, useCreateHabitPurposeMutation(), useHabitPurposeQueryGuard() (+9 more)
...
## Knowledge Gaps
- **1422 isolated node(s):** `name`, `private`, `version`, `type`, `packageManager` (+1417 more)
...
- **Why does `useConfirmDialog()` connect `Community 505` to `Community 224`, `Community 257`, `Community 168`, `Usetodos Todossettings`, `Community 78`, `Community 141`, `Community 54`, `Community 216`, `Community 283`, `Usehabitcategories Habitcategoriespage`, `Community 29`, `Searchselect Dropdownpos`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Quarters Activatequarter` to `Community 257`, `Createhabitpurposestep Usehabitpurposes`, `Weekly Routine`, `Usetodos Todossettings`, `Community 206`, `Community 78`, `Community 242`, `Toast Context`, `Activities Activity`, `Community 246`, `Community 54`, `Community 505`, `Community 186`, `Usehabitcategories Habitcategoriespage`, `Searchselect Dropdownpos`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `Router Todaypage` to `Activity Activitypickerfield`, `Community 395`, `Usetodos Todossettings`, `Community 206`, `Community 241`, `Community 274`, `Community 244`, `Loginform Resetpasswordform`, `Community 505`?**
...
- **Are the 19 inferred relationships involving `useConfirmDialog()` (e.g. with `ArchivedHabitCard()` and `Trigger()`) actually correct?**
  _`useConfirmDialog()` has 19 INFERRED edges - model-reasoned connections that need verification._