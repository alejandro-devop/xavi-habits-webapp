...
export const systemIcons = [
  ...
  { name: 'arrows-left-right', label: 'Mover', category: 'other', icon: faArrowsLeftRight, keywords: ['move', 'mover', 'trasladar'], showInPicker: false },
  { name: 'grip-vertical', label: 'Arrastrar', category: 'other', icon: faGripVertical, keywords: ['drag', 'handle', 'reordenar'], showInPicker: false },
